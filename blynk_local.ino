...
char auth[] = "PPTFJ5xNqzgJthS7tJoVsZLxrVd5UR_O";
char ssid[] = "pw nya gampil";
char pass[] = "bismillah12345";
...
void setup() 
{
  ...
  Blynk.begin(auth, ssid, pass, IPAddress(192,168,1,10), 5555);  //Menghubungkan NodeMCU ke Server Blynk menggunakan Wi-Fi
